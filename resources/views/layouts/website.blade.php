    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row align-items-stretch retro-layout-2">
          <div class="col-md-4">
            <a href="single.html" class="h-entry mb-30 v-height gradient" style="background-image: url('{{URL::to('website/')}}/images/img_1.jpg');">
            ...
            <a href="single.html" class="h-entry v-height gradient" style="background-image: url('{{URL::to('website/')}}/images/img_2.jpg');">
          ...
          <div class="col-md-4">
            <a href="single.html" class="h-entry img-5 h-100 gradient" style="background-image: url('{{URL::to('website/')}}/images/img_v_1.jpg');">
          ...
          <div class="col-md-4">
            ...
            <a href="single.html" class="h-entry v-height gradient" style="background-image: url('{{URL::to('website/')}}/images/img_4.jpg');">
      ...
      <div class="container">
        ...
        <div class="row align-items-stretch retro-layout">
          ...
          <div class="col-md-5 order-md-2">
            <a href="single.html" class="hentry img-1 h-100 gradient" style="background-image: url('{{URL::to('website/')}}/images/img_4.jpg');">
          ...
          <div class="col-md-7">
            ...
            <a href="single.html" class="hentry img-2 v-height mb30 gradient" style="background-image: url('{{URL::to('website/')}}/images/img_1.jpg');">
            ...
            <div class="two-col d-block d-md-flex">
              <a href="single.html" class="hentry v-height img-2 gradient" style="background-image: url('{{URL::to('website/')}}/images/img_2.jpg');">
              ...
              <a href="single.html" class="hentry v-height img-2 ml-auto gradient" style="background-image: url('{{URL::to('website/')}}/images/img_3.jpg');">
